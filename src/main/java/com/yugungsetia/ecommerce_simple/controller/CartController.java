...
import com.yugungsetia.ecommerce_simple.service.CartService;
...
public class CartController {
    ...
    @PutMapping("/items")
    public ResponseEntity<Void> updateItemCartQuantity(@Valid @RequestBody UpdateCartItemRequest request) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        UserInfo userInfo = (UserInfo) authentication.getPrincipal();
